...
namespace EmpAjaxJquery.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            return View(await _context.Emp1.ToListAsync());
        }
        ...
        public async Task<IActionResult> AddEmployee(int id = 0)
        {
            ...
            {
                var empl = await _context.Emp1.FindAsync(id);
                if (empl == null)
                {
                    return NotFound();
                }
        ...
        public async Task<IActionResult> AddEmployee(int id, [Bind("Emp_Id,Name,Gender,Department,Notes")] EmployeeModel emps)
        {
            if (ModelState.IsValid)
            {
                ...
                return Json(new { isValid = true, html = Helper.RenderRazorViewToString(this, "_ViewAll", _context.Emp1.ToList()) });
            }
        ...
        {
            var empl = await _context.Emp1.FindAsync(id);
            _context.Emp1.Remove(empl);
            await _context.SaveChangesAsync();
            return Json(new { html = Helper.RenderRazorViewToString(this, "_ViewAll", _context.Emp1.ToList()) });
        }

        private bool EmployeeModelExists(int id)
        {
            return _context.Emp1.Any(e => e.Emp_Id == id);
        }
    }
}
